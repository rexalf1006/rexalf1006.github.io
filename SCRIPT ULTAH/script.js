...
new TypeIt("#teks1", {
  strings: ["SAYANGGGGG ", " ", "SELAMAT ULANG TAHUN YAAAA, ", " ", "<b>Selamat Ulang Tahun Yang ke - 20</b>", " ", "Kepada Mba Lipa Pacar ku yang imut, semoga kamu panjang umur, dan bahagia selalu. .", , " ", , " ", "- Alfred, Bang Jago kwkwkw "],
  startDelay: 4000,
  speed: 80,
...
new TypeIt("#teks2", {
  strings: ["Haii cabi!!", "Happy Birthday ya..", " ", "Wahahahha udah 20 tahun, udah makin gede , semoga di umur yang sekarang kamu bisa jadi pribadi yang lebih baik lagi, lebih rajin, lebih dewasa lagi, dan lebih berbakti.", "Maaf ya aku gabisa kasih surprise yang romantis. Cuma ini yang bisa aku kasih ke kamu, aku harap kamu suka ya :)", "Sekali lagi, Selamat Ulang Tahun ya. Semoga semua impian, keinginan, dan harapan kamu bisa tercapai, Aamiin."],
  startDelay: 2000,
  speed: 80,
  waitUntilVisible: true
}).go();
